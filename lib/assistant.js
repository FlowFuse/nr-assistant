...
class Assistant {
    ...
    async init (RED, options = {}) {
        if (this._loading) {
            this.RED.log.debug('FlowFuse Assistant is busy loading')
            return
        }
        ...
        if (this.options.standalone) {
            if (wasStandaloneEnabled && !this.options.enabled) {
                ...
                this.RED.log.info('FlowFuse Assistant Plugin has been disabled')
                ...
                this.RED.log.info('FlowFuse Assistant Plugin is running in standalone mode')
            }
